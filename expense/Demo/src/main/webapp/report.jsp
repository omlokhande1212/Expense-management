...
.navbar {
    ...
    /* Table Amount Column */
    .expense-table-section td:nth-child(3) {
        font-weight: bold;
        color: #28a745;
    }
    ...
    <div class="container">
      ...
      <div class="text-right mb-3">
        <form method="post" action="downloadCSV.jsp">
         ...
         <tr>
                <center><p><b>Filter Results</b></p></center>
                <th><b>Category: <b></b><span><%= request.getParameter("category") != null ? request.getParameter("category") : "All" %></span></th>
                <th>Start Date: <span><%= request.getParameter("start_date") != null ? request.getParameter("start_date") : "N/A" %></span></td>
                <th>End Date: <span><%= request.getParameter("end_date") != null ? request.getParameter("end_date") : "N/A" %></span></th>
            </div>
      </div>
        ...
        <table class="table table-bordered text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="amount">$<%= expenseRs.getDouble("amount") %></td>
